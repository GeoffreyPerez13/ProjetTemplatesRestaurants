...
<div class="reset-password-container">
    ...
    <?php if (empty($token)): ?>
        ...
        <form method="post" action="?page=reset-password-admin">
    ...
    <?php else: ?>
        ...
        <form method="post" action="?page=reset-password-admin" id="reset-password-form">
            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token ?? '') ?>">
    ...
    <!-- PAS DE LIEN DE RETOUR - CONTEXTE ADMIN SÉCURISÉ -->
</div>
