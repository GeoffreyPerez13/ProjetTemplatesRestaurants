// dark-mode.js — Toggle dark mode pour la page landing (vitrine publique)
(function () {
    'use strict';

    const STORAGE_KEY = 'menucraft-landing-dark-mode';
     ...
     */
    function init() {
        const btn = document.getElementById('landing-dark-mode-toggle');
        if (btn) {
